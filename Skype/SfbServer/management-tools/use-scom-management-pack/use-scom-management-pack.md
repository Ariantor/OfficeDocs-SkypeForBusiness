...
- **Changes in the latest update** -	Some alerts have had special characters removed, which in certain conditions, would interfere with the SCOM command channel notification feature.
